...
const ServiceComponent = () => {
    ...
    return (
        <div className="p-5 mb-10">
            <div className="flex w-[70%] flex-wrap items-center gap-2 m-auto justify-center mb-8">
                <div className="bg-sky-500 transition-all duration-700 text-center text-white w-[130px] pt-2 pb-2 hover:bg-sky-700 rounded shadow-lg hover:shadow-xl ">طلبات الخدمة<br />983567</div>
                <div className="bg-sky-500 transition-all duration-700 text-center text-white w-[130px] pt-2 pb-2 hover:bg-sky-700 rounded shadow-lg hover:shadow-xl">الممارسين<br />12789</div>
                <div className="bg-sky-500 transition-all duration-700 text-center text-white w-[130px] pt-2 pb-2 hover:bg-sky-700 rounded shadow-lg hover:shadow-xl">خدمة الفنادق<br />2800</div>
                <div className="bg-sky-500 transition-all duration-700 text-center text-white w-[130px] pt-2 pb-2 hover:bg-sky-700 rounded shadow-lg hover:shadow-xl">المنصات الشركة<br />250</div>
            </div>
