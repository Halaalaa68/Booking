      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {offers.map((offer, index) => (
          ...
          >
            ...
            <div className="border-t border-gray-100 pt-4 mb-4">
              ...
              <div className="flex items-center justify-between">
                <p className="font-semibold text-blue-600">
                  {offer.minimumAmount.toLocaleString()} {offer.currency}
                </p>
            ...
            <button 
              className={`w-full ${loadingIndex !== null || signedOffers.includes(index) ? 'bg-gray-400' : 'bg-blue-600'} text-white py-3 rounded-md font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2`}
            ...
            >
              {loadingIndex === index ? 'جارٍ التوقيع...' : signedOffers.includes(index) ? 'تم التوقيع' : 'توقيع'}
            </button>
          </div>
        ))}
      </div>
