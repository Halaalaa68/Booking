...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 mb-16 shadow-md">
      <header className="fixed w-full bg-[#0074fe] p-3 flex justify-between items-center z-50">
                      <Image 
                          src={logo}
                          alt="WorkHotel Logo" 
                          height={40} 
                      ...
                      />
                      <button 
                          className="btn cursor-pointer bg-white px-4 py-2 rounded"
      ...
      <div className="p-5">
          ...
          <nav className="mt-6">
            <ul className="space-y-1">
              ...
              <li>
                <span>
                <Link href="/login" onClick={() => setIsOpen(false)} className="flex justify-end items-center gap-2 px-4 py-3 rounded-md hover:bg-red-50 text-red-600 font-medium transition-colors duration-200">
