...
const TaskList = () => {
    ...
    function handleSignID(){
        ...
        const currentHotel = parseInt(selectedHotel);
        const nextHotel = (currentHotel + 1).toString();
        localStorage.setItem('selectedHotel', nextHotel);
        ...
        <div className="w-full p-4 bg-white rounded-lg shadow-md" dir="rtl">
            ...
            {tasksCompleted && (
                <div className="mt-4 text-center">
                    ...
                    <button onClick={()=>handleSignID()} className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg font-medium mt-3 transition duration-300">
